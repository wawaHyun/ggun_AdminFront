...
export async function allAdminsP() {
    const response = await client.admins.findMany({})
    return response
}

export async function colsadminP() {
    const response = await client.admins.findFirst({})
    return response
}

export async function findAdminByIdP(id: number) {
    const response = await client.admins.findFirst({
        where: { id: id },
    })
    return response
...
export async function deleteAdminP(id: number) {
...
export async function existAdminP(username: string) {
...
export async function loginAdminP(admin: IAdmin) {
...
export async function logoutAdminP(id: number) {
    const response = await client.admins.update({
        where: {
            id: id,
        },
...
export async function joinAdminP(admin: IAdmin) {
