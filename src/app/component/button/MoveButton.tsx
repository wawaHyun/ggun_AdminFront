...
export const MoveButton = ({ text, path, color,select }: IButton) => {
    return (
        <button key={1}
        onClick={path}
        type="button"
...
export const MoveButton2 = ({ text, path, color,select }: IButton) => {
    return (
        <button key={1}
        onClick={path}
        type="button" 
...
export const GrayButton = ({ text, path, color,select }: IButton) => {
    return (
        <button key={1}
        onClick={path}
        type="button" 
