...
import { CallIcon, ChartIcon, DownIcon, HomeIcon, ListIcon, MailIcon, NewsIcon, UpIcon } from '@/app/atoms/icons/icons';
      ...
      <div className="border p-2 rounded bg-white">
        <div className="text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700">
          <ul className="flex flex-wrap -mb-px">
            {menus.map((i) => (
              <li className="me-2">
                <a href={i.address} className="inline-block p-2 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300">{i.icon}{i.title}</a>
              </li>
            ))}
          </ul>
