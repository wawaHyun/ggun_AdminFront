...
export default function BoardSave() {
  ...
  const onSubmit = (data: any) => {
    ...
    .catch((error:any)=>{
      alert('board onSubmit error : ' + error)
    })
  } 
  ...
  return (
    <form className="max-w mx-auto" onSubmit={handleSubmit(onSubmit)}>
      <div className="editor mx-auto w-10/12 flex flex-col text-gray-800 border border-gray-300 p-4 shadow-lg max-w-2xl">
        <label htmlFor="countries" className=" block mb-2 text-lg text-center font-medium text-gray-900 ">게시판 추가</label>

        <input className="title bg-gray-100 border border-gray-300 p-2 mb-4 outline-none" placeholder="게시판 Title"
