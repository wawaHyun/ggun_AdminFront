...
import Calendar from "@/app/component/common/module/calender";
...
export default function ChargingStationSharp() {
    return (
        <div className="w-screen h-full flex justify-center">
                <div className="grid grid-cols-4 gap-2 w-[80%] h-[100%] content-center text-center">
                    ...
                    <div className=" "><BaseBox content={<div><p>일별 접속자수 </p><TableDemo /></div>}/></div>
