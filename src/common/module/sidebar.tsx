...
import { CallIcon, ChartIcon, HomeIcon, ListIcon, MailIcon, NewsIcon, XIcon } from '@/app/atoms/icons/icons';
import { PG } from '../enums/PG';
import { useState } from "react";
import { fetchLogoutUser } from "../../users/service/user.service";
import { useDispatch } from "react-redux";
import profile from "@/app/atoms/img/앗사깨꾹.gif"
import Image from "next/image";
import { GrayButton } from "@/app/atoms/button/MoveButton";
import Chartting from "@/app/pages/dashboard/alarm/page";
...
function Sidebar() {
    ...
    return (
        <div className="bg-white">
            ...
            {isOpen == true ?
                <nav className="absolute top-6 rounded-lg left-0 h-auto w-auto mt-10 bg-white text-black border shadow-lg p-3">
                    <ul className="bg-white mb-4">
                        <li className="">
                            <Image src={profile} className="rounded-full w-full h-auto border border-ggun-100" alt="my profile" />
                        </li>
